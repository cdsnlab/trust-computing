...
#* for RL 
from cares_rl_sb_custom_actions_env import trustEnv
...
if __name__ == "__main__":
    # for output in named_product(v_d=[1], v_lr=[0.1], v_df=[0.1], v_eps=[0.1], v_fd=[1], v_s=[12000], v_i=[10, 50, 90], v_mvp=[0.1, 0.2, 0.3, 0.4], v_mbp=[0.1, 0.3, 0.5, 0.7, 0.9], v_oap=[0.1, 0.15, 0.2, 0.25, 0.3], v_ppvnpvthr= [0.5]): 
    for output in named_product(v_d=[1], v_lr=[0.1], v_df=[0.1], v_eps=[0.1], v_fd=[1], v_s=[12000], v_i=[10], v_mvp=[0.2], v_mbp=[0.9], v_oap=[0.3], v_ppvnpvthr= [0.5]): 
    # for output in named_product(v_d=[1], v_lr=[0.1], v_df=[0.1], v_eps=[0.5], v_fd=[1], v_s=[12000], v_i=[10], v_mvp=[0.1, 0.2, 0.3, 0.4], v_mbp=[0.1, 0.3, 0.5, 0.7, 0.9], v_oap=[0.1, 0.15, 0.2, 0.25, 0.3], v_ppvnpvthr= [0.5]): 

    # for output in named_product(v_d=[1], v_lr=[0.1], v_df=[0.1], v_eps=[0.1], v_fd=[1], v_s=[12000], v_i=[10], v_mvp=[0.3], v_mbp=[0.9], v_oap=[0.3], v_ppvnpvthr= [0.5]):
...
slacknoti("CARES-S SB:V finished", 's')
