...
# for output in named_product(v_i = [10, 50, 90], v_s = [59999], v_mvp=[0.2], v_mbp=[0.5], v_oap=[0.1]): 
    ...
    for i in range (run_counts):
        ...
        while True:
            ...
            print(interaction_number,  threshold, PPV, NPV)
            # print((STEPS+1)/100)
