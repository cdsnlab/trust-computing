...
def connect():
    ...
    dtmdcoll = db['dtm-d']
    istmdcoll = db['istm-d']
    return carescoll, rtmcoll, dtmcoll, istmcoll, rtmdcoll, dtmdcoll, istmdcoll
...
carescoll, rtmcoll, dtmcoll, istmcoll, rtmdcoll, dtmdcoll, istmdcoll = connect()
...
for k in allcombination:
    ...
    mydoc=list(carescoll.find(myquery, {"_id":0, "accuracy": 1, 'precision':1, 'recall':1}))
    # print(mydoc)
