...
if __name__ == "__main__":
    ...
    for output in named_product(v_d=[1,5, 9], v_lr=[0.1], v_df=[0.1], v_eps=[0.1], v_fd=[1], v_s=[59999], v_i=[10,50,90], v_mvp=[0.2], v_mbp=[0.1], v_oap=[0.2]):
    #! run with mbp 1 -> should show
        ...
        for i in range(run_counts): #* RUN THIS xxx times each and make an average.
            ...
            while True: 
                ...
                # if env.next_car_index % (100-DELAY) ==0:
                    ...
                    env.append_accuracy(i, env.next_car_index)
