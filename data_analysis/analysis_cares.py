...
data = pd.read_csv('/home/spencer1/trust-computing/sampledata/cares_df_0_0.5mbp0.2oap0.2mvp.csv', sep=',', error_bad_lines=False, encoding='latin1', header=0, nrows=3200000)

fig = go.FigureWidget(
    layout=go.Layout(title="Trust values plottingfor CARES_DB ",xaxis=dict(title="Indirect"),yaxis=dict(title="Direct", range=[0,100] ))
)
