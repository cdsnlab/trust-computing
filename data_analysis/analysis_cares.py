...
data = pd.read_csv('/home/spencer/trust-computing/sampledata/cares_df_0_0.5mbp0.2oap0.2mvp.csv', sep=',', error_bad_lines=False, encoding='latin1', header=0)
...
fig.update_layout(height=60000, width=100, title_text="CARES dataset (split by NUM_ITERACTION)")
